# 0 "/home/user/Cora-Z7-DAQ-OS/project-spec/hw-description/system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/user/Cora-Z7-DAQ-OS/project-spec/hw-description/system-top.dts"
/dts-v1/;
# 1 "/home/user/Cora-Z7-DAQ-OS/project-spec/hw-description/zynq-7000.dtsi" 1
# 10 "/home/user/Cora-Z7-DAQ-OS/project-spec/hw-description/zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "/home/user/Cora-Z7-DAQ-OS/project-spec/hw-description/system-top.dts" 2
# 1 "/home/user/Cora-Z7-DAQ-OS/project-spec/hw-description/pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  #address-cells = <1>;
  #size-cells = <1>;
  firmware-name = "CoraZ707S-0x000000100-20250413135344-matterhorn-d1a5e3d.bit.bin";
  clocking0: clocking0 {
...
# 4 "/home/user/Cora-Z7-DAQ-OS/project-spec/hw-description/system-top.dts" 2
# 1 "/home/user/Cora-Z7-DAQ-OS/project-spec/hw-description/pcw.dtsi" 1
 &ps7_cortexa9_0 {
  xlnx,rable = <0>;
 ...
 &amba {
  ...
  M_AXI_ps: M_AXI_ps@46000000 {
   status = "okay";
   compatible = "M_AXI_ps";
   xlnx,ip-name = "M_AXI_ps";
   reg = <0x46000000 0x20000>;
   xlnx,name = "M_AXI_ps";
  };
 };
 &uart0 {
...
# 5 "/home/user/Cora-Z7-DAQ-OS/project-spec/hw-description/system-top.dts" 2
/ {
 board = "cora-z7-07s";
 device_id = "7z007s";
 slrcount = <1>;
 ...
 cpus_a9: cpus-a9@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x46000000 &M_AXI_ps 0x46000000 0x20000>,
...
# 1 "/home/user/Cora-Z7-DAQ-OS/project-spec/hw-description/coraz7.dtsi" 1
# 1 "/home/user/Cora-Z7-DAQ-OS/project-spec/hw-description/zynq-7000.dtsi" 1
# 10 "/home/user/Cora-Z7-DAQ-OS/project-spec/hw-description/zynq-7000.dtsi"
/ {
 #address-cells = <1>;
...
# 2 "/home/user/Cora-Z7-DAQ-OS/project-spec/hw-description/coraz7.dtsi" 2
# 1 "/home/user/Cora-Z7-DAQ-OS/project-spec/hw-description/include/dt-bindings/gpio/gpio.h" 1
# 3 "/home/user/Cora-Z7-DAQ-OS/project-spec/hw-description/coraz7.dtsi" 2
...
# 80 "/home/user/Cora-Z7-DAQ-OS/project-spec/hw-description/system-top.dts" 2
# 1 "/home/user/Cora-Z7-DAQ-OS/project-spec/hw-description/custom_pl.dtsi" 1
# 81 "/home/user/Cora-Z7-DAQ-OS/project-spec/hw-description/system-top.dts" 2
